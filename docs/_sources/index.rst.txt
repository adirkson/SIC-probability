...
===========================================================
This module is for making probabilistic forecasts of sea ice concentration (SIC) using the methods described in Dirkson et al, 2018.
...
This project was built in Python v2.7.
